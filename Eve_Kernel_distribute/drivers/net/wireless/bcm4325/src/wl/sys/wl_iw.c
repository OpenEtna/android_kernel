...
)
{
	...
	if (g_onoff == G_WLAN_SET_OFF) {
		...
		schedule_timeout((100*HZ)/1000);
		 ...
		 //START - Added by Broadcom to counter Wifi Reconnect from Sleep Problem
		 wl_iw_send_priv_event(dev, "START");
 		 //END - Added by Broadcom to counter Wifi Reconnect from Sleep Problem
