...
static struct delayed_work sensor_task;
static unsigned char sensor_value;
...
static void read_sensor(struct work_struct *work)
{
...
{
	bd6083_write_reg(client, 0x03, level);
}
